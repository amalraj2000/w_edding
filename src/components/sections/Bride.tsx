...
export default function BrideSection() {
  ...
  return (
    ...
    >
      <div
        className="absolute top-1/2 right-1/4 -translate-y-1/2 w-96 h-96 pointer-events-none -z-0"
      ...
      <div className="max-w-3xl mx-auto relative z-10">
        ...
        >
          <p className="section-eyebrow mb-3">Meet The Bride</p>
          <h2
        ...
        >
          ...
          >
            ...
            >
              ...
              <p className="font-semibold text-base" style={{ color: '#C8BAB0' }}>{bride.father} &amp; {bride.mother}</p>
            </div>
            ...
            >
              ...
              <p className="font-semibold text-base" style={{ color: '#C8BAB0' }}>{bride.house}</p>
            </div>
            ...
            >
              ...
              <p className="font-semibold text-base" style={{ color: '#C9A96E' }}>{bride.place}</p>
            </div>
          </div>
        </motion.div>
      </div>
